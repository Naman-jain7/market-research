...
class AgentOutput(BaseModel):
    ...
    score: Annotated[float | None, Field(default=None, description="Overall evaluation score assigned by the agent on a scale from 0 to 10, where 10 is the strongest assessment.")]
